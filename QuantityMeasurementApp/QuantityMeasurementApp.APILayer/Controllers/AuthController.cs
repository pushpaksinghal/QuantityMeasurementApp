...
namespace QuantityMeasurementApp.APILayer.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(UserManager<ApplicationUser> userManager,SignInManager<ApplicationUser> signInManager,JwtTokenService jwtTokenService,ILogger<AuthController> logger)
        {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequestDto request)
        {
            ...
            {
                _logger.LogWarning("User exists {Email}",request.Email);
            ...
            return Ok(new AuthResponseDto{Token=tokenResult.Token,Email=user.Email??string.Empty,ExpiresAt=tokenResult.ExpiresAt});
        }
        ...
        public async Task<IActionResult> GoogleResponse()
        {
            ...
            if(string.IsNullOrWhiteSpace(email)) return BadRequest("Email not received.");
            ...
            var tokenResult=await _jwtTokenService.CreateTokenAsync(user);
            return Ok(new{Token=tokenResult.Token,Email=user.Email,ExpiresAt=tokenResult.ExpiresAt});
        }
    }
}