    ...
    public sealed class Quantity<U> where U : struct, Enum
    {
        ...
        private static IMeasurableUnit AdapterFor(U unit)
        {
            ...
            if (typeof(U) == typeof(TemperatureUnit))
                return TemperatureUnitAdapter.From((TemperatureUnit)(object)unit);
        ...
        private static void ValidateArithmeticOperands(Quantity<U> left, Quantity<U>? right, U? targetUnit, bool targetUnitRequired)
        {
            if (left is null)
        ...
        private static double PerformBaseArithmetic(Quantity<U> left, Quantity<U> right, ArithmeticOperation op)
        {
            ...
            leftAdapter.ValidateOperationSupport(op.ToString());
            rightAdapter.ValidateOperationSupport(op.ToString());
