...
namespace QuantityMeasurementApp.Test.EntityTest
{
    ...
    public class LengthAdditionTargetUnitTests
    {
        ...
        public void testAddition_ExplicitTargetUnit_Feet()
        {
            ...
            Quantity<LengthUnit> sum = Quantity<LengthUnit>.AddToSpecificUnit(a, b, LengthUnit.FEET);
        ...
        public void testAddition_ExplicitTargetUnit_Inch()
        {
            ...
            Quantity<LengthUnit> sum = Quantity<LengthUnit>.AddToSpecificUnit(a, b, LengthUnit.INCH);
        ...
        public void testAddition_ExplicitTargetUnit_Yard()
        {
            ...
            Quantity<LengthUnit> sum = Quantity<LengthUnit>.AddToSpecificUnit(a, b, LengthUnit.YARD);
        ...
        public void testAddition_ExplicitTargetUnit_Centimeters()
        {
            ...
            Quantity<LengthUnit> sum = Quantity<LengthUnit>.AddToSpecificUnit(a, b, LengthUnit.CENTIMETERS);
        ...
        public void testAddition_ExplicitTargetUnit_Commutativity()
        {
            ...
            Quantity<LengthUnit> sum1 = Quantity<LengthUnit>.AddToSpecificUnit(a, b, LengthUnit.YARD);
            Quantity<LengthUnit> sum2 = Quantity<LengthUnit>.AddToSpecificUnit(b, a, LengthUnit.YARD);
        ...
        public void testAddition_ExplicitTargetUnit_NullSecondOperand_Throws()
        {
            ...
            Assert.Throws<ArgumentException>(() =>
                Quantity<LengthUnit>.AddToSpecificUnit(a, null, LengthUnit.FEET)
            );
        }
        ...
        public void testAddition_ExplicitTargetUnit_InvalidTargetUnit_Throws()
        {
            ...
            Assert.Throws<ArgumentException>(() =>
                Quantity<LengthUnit>.AddToSpecificUnit(a, b, badTarget)
            );
        }
    }
}