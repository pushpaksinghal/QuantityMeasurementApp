...
namespace QuantityMeasurementApp.Test.EntityTest
{
    ...
    public class WeightConversionTests
    {
        ...
        {
            double result = Weight.Convert(2.0, WeightUnit.POUND, WeightUnit.KILOGRAM);
        ...
        {
            double result = Weight.Convert(500.0, WeightUnit.GRAM, WeightUnit.POUND);
        ...
        {
            double result = Weight.Convert(1.0, WeightUnit.POUND, WeightUnit.GRAM);
        ...
        {
            double result = Weight.Convert(5.0, WeightUnit.KILOGRAM, WeightUnit.KILOGRAM);
        ...
        {
            double result = Weight.Convert(0.0, WeightUnit.KILOGRAM, WeightUnit.GRAM);
        ...
        public void testConversion_RoundTrip_PreservesValue()
        {
            ...
            double toPound = Weight.Convert(v, WeightUnit.KILOGRAM, WeightUnit.POUND);
            double backToKg = Weight.Convert(toPound, WeightUnit.POUND, WeightUnit.KILOGRAM);
        ...
        public void testConversion_NaN_Throws()
        {
            Assert.Throws<ArgumentException>(() =>
                Weight.Convert(double.NaN, WeightUnit.KILOGRAM, WeightUnit.GRAM)
            );
        }
        ...
        {
            Assert.Throws<ArgumentException>(() =>
                Weight.Convert(double.PositiveInfinity, WeightUnit.KILOGRAM, WeightUnit.GRAM)
            );
        }
        ...
        {
            Assert.Throws<ArgumentException>(() =>
                Weight.Convert(double.NegativeInfinity, WeightUnit.KILOGRAM, WeightUnit.GRAM)
            );
        }
        ...
        public void testConversion_InvalidEnumValue_Throws()
        {
            ...
            Assert.Throws<ArgumentException>(() =>
                Weight.Convert(1.0, bad, WeightUnit.GRAM)
            );
        }
    }
}